...
def standardsort(bigdir, xaxis, sortlist=None, pnw_topo=None):
    ...
    # else:
    plt_rep(rep_mat, rep_arr, rep_list)
    # return tclist
...
def plt_rep(rep_mat, 
    ...
    # if (('topocollist' in locals()) & ('toposhortlist' in locals())):
    ...
    plt.savefig('tree_behaviour_40replicates.pdf', bbox_inches='tight')
...
TOPOSHORT = {'((((vsylveast,vsylvwest),vvwest),vveast),(vitisasia,vitisusa));': '(vasia,vusa),(vvea,(vvwe,(vsea,vswe)))',
 '((((vsylveast,vveast),vvwest),vsylvwest),(vitisasia,vitisusa));': '(vasia,vusa),(vswe,(vvwe,(vsea,vvea)))',
 '((((vsylveast,vvwest),vsylvwest),vveast),(vitisasia,vitisusa));': '(vasia,vusa),(vvea,(vswe,(vsea,vvwe)))',
 '((((vveast,vvwest),vsylveast),vsylvwest),(vitisasia,vitisusa));': '(vasia,vusa),(vswe,(vsea,(vvea,vvwe)))',
 '(((vsylveast,vveast),(vsylvwest,vvwest)),(vitisasia,vitisusa));': 'scen_class',
 '(((vsylveast,vsylvwest),(vveast,vvwest)),(vitisasia,vitisusa));': '(vasia,vusa),((vsea,vswe),(vvea,vvwe))',
 '((((vsylvwest,vvwest),vsylveast),vveast),(vitisasia,vitisusa));': '(vasia,vusa),(vvea,(vsea,(vswe,vvwe)))' }
...
BIGDIR = '/Users/Thomsn/Desktop/Studium/MEME Programme [current]/Universite de Montpellier [Sem2]/internship_scornavacca_lab/git_lab/phylogenetto/data/real_data/vitis/phylonetworks/2020_04_vitis_USA_2_summary_40_reps'

standardsort(BIGDIR, xaxis, sortlist=None)
