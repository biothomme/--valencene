# Version 1.3
# this script is taken from: https://github.com/melisaolave/SNPs2CF.git .
# there it has the name: functions.R and is the core of the package
# SNPs2CF. more information can be found here.
#
# for use: please cite
# Olave, M. and Meyer, A.X.E.L., 2020. Implementing Large Genomic SNP 
# Datasets in Phylogenetic Network Reconstructions: A Case Study of 
# Particularly Rapid Radiations of Cichlid Fish. Systematic biology.
