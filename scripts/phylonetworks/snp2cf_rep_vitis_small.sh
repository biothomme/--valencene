...
#$ -o clusterlog/vitis_snps2cf_rep_16_20.out
#$ -e clusterlog/vitis_snps2cf_rep_16_20.err
...
SCRIPT="./scripts/phylonetworks/rep_cfrepeatr_small.sh" 
INPUT="data/real_data/vitis/phylonetworks/2020_04_vitis_imputed_pnw_rep/"
sh "$SCRIPT" "$INPUT"
