...
#$ -o clusterlog/pn_fastme_treetwo
...
DIRR="./data/real_data/vitis/phylonetworks/2020_04_vitis_USA_2_summary_40_reps"
FASTMESC="./scripts/phylonet/fastme_fastyou.sh"
